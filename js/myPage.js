    ...
    $('#fullpage').fullpage({ // fullpage  方法里面接受json对象形式
    	...
    	onLeave: function(index, nextIndex, direction) {
    		...
    		if(index == 2 && nextIndex == 3) {
    			...
    			// 沙发要往第三屏幕走，  走的距离 就是  当前屏幕的高度 - main 到底部的高度 - 沙发到main的距离    (当前屏幕的高度  - 250 )
            ...
            // 这是第8屏幕动画
              ...
              //    $(".btn-08-a").hide();
              // });
              // hover 来替代更简洁：一个盒子鼠标经过显示离开隐藏用hover和toggle混搭
